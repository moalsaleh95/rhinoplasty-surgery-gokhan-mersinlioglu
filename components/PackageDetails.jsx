...
export const PackageDetails = () => {
  return (
    <div className='h-[990px] bg-[#282866] w-full text-center mx-auto'>
      <h2 className="text-[34px] font-bold text-[#fff] pt-[63px] mt-[90px]">
      ...
      <div className="grid grid-cols-3 pt-[110px] mx-auto gap-x-[94px] container justify-items-center ">
      ...
      <div className="grid grid-cols-2 gap-x-[94px] pt-[110px] container justify-items-center mx-auto">
