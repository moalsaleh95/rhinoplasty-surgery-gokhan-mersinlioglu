...
export const Form = () => {
  return (
    <div className='md:relative absolute md:bottom-[0] bottom-[-20rem] mt-[203px] md:w-[437px] w-[335px] h-[523px] md:bg-white bg-[#282866] border-[#6969FF] border-2 rounded-lg'>
